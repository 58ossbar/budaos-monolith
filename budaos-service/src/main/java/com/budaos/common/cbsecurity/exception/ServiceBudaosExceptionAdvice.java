package com.budaos.common.cbsecurity.exception;

import com.budaos.common.constants.ExecStatus;
import com.budaos.common.exception.BudaosException;
import com.budaos.common.exception.RepeatedSubmitFormException;
...
/**
 * Title:异常处理器 Copyright: Copyright (c) 2017 Company:budaos.co.,ltd
 * 
 * @author budaos.co.,ltd
 * @version 1.0
 */
@RestControllerAdvice
public class ServiceBudaosExceptionAdvice {
	 ...
	 * 自定义异常
	 */
	@ExceptionHandler(BudaosException.class)
	public Object handleBudaosException(BudaosException e, HttpServletRequest request,
	...
	public Object handleSQLIntegrityConstraintViolationException(SQLIntegrityConstraintViolationException ex, HttpServletRequest request,
			HttpServletResponse response) {
		logger.error(ex.getMessage(), ex);
		return returnValue(R.error("外键约束，操作失败！"), request, response);
	...
	public Object handleAuthorizationException(AuthorizationException e, HttpServletRequest request,
		...
		return returnValue(R.error("没有权限，请联系管理员授权"), request, response);
	...
	*/
	 ...
	 */
	/*
	@ExceptionHandler({ UnauthorizedException.class, SpelEvaluationException.class })
	public Object handleUnauthorizedException(UnauthorizedException ex, HttpServletRequest request,
		...
		if (!WebUtil.isAjaxRequest(request)) {
			...
			try {
				...
				builder.append("document.write('<font color=\"red\">无权限,请联系管理员！</font>');");
				// builder.append("window.top.location.href='" + loginurl + "'");
		...
		return returnValue(R.error("无权限,请联系管理员！"), request, response);
