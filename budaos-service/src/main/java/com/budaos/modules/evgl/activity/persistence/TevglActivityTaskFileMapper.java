...
@Mapper
public interface TevglActivityTaskFileMapper extends BaseSqlMapper<TevglActivityTaskFile> {
	 ...
	 * @param list
	 */
	void updateBatchByDuplicateKey(@Param("list") List<TevglActivityTaskFile> list);
}