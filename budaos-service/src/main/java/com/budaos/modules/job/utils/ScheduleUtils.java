package com.budaos.modules.job.utils;
...
public class ScheduleUtils {
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new BudaosException("获取定时任务CronTrigger出现异常", e);
        }
    }
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJobEntity scheduleJob) {
        try {
            ...
            // 若 Job 已存在（JDBC 持久化模式下重启时），先删除旧 Job 再重新创建，避免 ObjectAlreadyExistsException
            if (scheduler.checkExists(getJobKey(scheduleJob.getJobId()))) {
            ...
            throw new BudaosException("创建定时任务失败", e);
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJobEntity scheduleJob) {
        try {
            ...
            throw new BudaosException("更新定时任务失败", e);
        }
    }
    ...
    public static void run(Scheduler scheduler, ScheduleJobEntity scheduleJob) {
        try {
            ...
            throw new BudaosException("立即执行定时任务失败", e);
        }
    }
    ...
    public static void pauseJob(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new BudaosException("暂停定时任务失败", e);
        }
    }
    ...
    public static void deleteScheduleJob(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new BudaosException("删除定时任务失败", e);
        }
    }
}
