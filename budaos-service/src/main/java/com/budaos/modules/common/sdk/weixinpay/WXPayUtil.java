package com.budaos.modules.common.sdk.weixinpay;
...
//        File file = ResourceUtils.getFile(cert_url);
        //部署jar包获取
        //InputStream is = WordUtil.class.getClassLoader().getResourceAsStream(cert_url);
        InputStream is = WXPayUtil.class.getResourceAsStream(cert_url);
        try {
