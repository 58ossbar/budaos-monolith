package com.budaos.modules.evgl.empirical.domain;
...
public class TevglEmpiricalLogAudio extends BaseDomain<TevglEmpiricalLogAudio>{
	private static final long serialVersionUID = 1L;
	
	//alias
	public static final String TABLE_ALIAS = "TevglEmpiricalLogAudio";
	...
	public static final String ALIAS_AUDIO_ID = "音频id";
    ...
    /**
     * 音频id       db_column: audio_id 
     */	
 	@NotNull(msg="音频id不能为空")
 	@MaxLength(value=32, msg="字段[音频id]超出最大长度[32]")
	...
	public void setAudioId(java.lang.String value) {
		this.audioId = value;
	}
